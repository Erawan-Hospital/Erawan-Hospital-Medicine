...
var FIELD_ALIASES = {
  ...
  logs: {
    date:   ['date', 'วันที่', 'วันที่รับเข้า', 'วันที่ส่งออก', 'วันที่จ่าย'],
    time:   ['time', 'เวลา'],
    name:   ['name', 'ชื่อยา', 'ชื่อ'],
    unit:   ['unit', 'หน่วย', 'หน่วยนับ'],
    qty:    ['qty', 'quantity', 'จำนวน', 'จำนวนรับเข้า', 'จำนวนส่งออก'],
    lot:    ['lot', 'ล็อต', 'เลขล็อต', 'lot no'],
    person: ['person', 'ผู้รับเข้า', 'ผู้ส่งออก', 'ผู้ทำรายการ', 'ผู้บันทึก', 'โดย'],
    place:  ['place', 'แหล่งที่มา', 'รับเข้าจาก', 'ส่งออกไปที่', 'ปลายทาง', 'ต้นทาง', 'from', 'to']
  },
  users: {
